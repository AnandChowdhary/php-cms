<?php
	...
	foreach ($posts as $post) {
		echo "<a href='" . getSiteUrl() . "post/" . $post["slug"] . "' style='margin-bottom: 10px; display: block; text-decoration: none; line-height: 1.5; border-radius: 4px; padding: 15px; border: 1px solid #ccc;'><div><strong>" . $post["title"] . "</strong></div><div>" . getSummary($post["content"]) . "</div></a>";
	}
?>